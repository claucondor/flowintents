...
/// and createEVMIntent() for ScheduledManagerV0_2 to register EVM-originated intents.
///
...
access(all) contract IntentMarketplaceV0_2 {
    ...
    access(all) resource Intent {
        ...
        // ---- V0_2 additions: dual-chain fields ----
    ...
    access(all) resource Marketplace {
        ...
        access(all) fun createYieldIntent(
            ...
            let id = IntentMarketplaceV0_2.totalIntents
            ...
            IntentMarketplaceV0_2.intents[id] <-! intent
            IntentMarketplaceV0_2.totalIntents = IntentMarketplaceV0_2.totalIntents + 1
        ...
        access(all) fun cancelIntent(
            ...
            pre {
                IntentMarketplaceV0_2.intents[id] != nil: "Intent does not exist"
            }
    ...
    init() {
        self.totalIntents = 0
        self.intents <- {}
        self.MarketplaceStoragePath = /storage/FlowIntentsMarketplaceV2
        self.MarketplacePublicPath  = /public/FlowIntentsMarketplaceV2
